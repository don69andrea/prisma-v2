...
_TABLES: dict[str, tuple[list[str], list[str]]] = {
    ...
    "crypto_price_history": (
        ["ticker", "timestamp", "interval", "open", "high", "low", "close", "volume", "currency", "source"],
        ["ticker", "timestamp", "interval"],
    ),
    "stock_fundamentals": (
        ["ticker", "period_end", "publish_date", "period_type", "pe_ratio", "pb_ratio",
         "ev_ebitda", "roe", "debt_equity", "fcf_margin", "eps_chf", "eps_growth_yoy",
         "revenue_growth", "dividend_yield", "dividend_growth", "market_cap_chf", "sector", "source"],
