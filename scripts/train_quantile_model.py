...
def train(df: pd.DataFrame, n_folds: int = 5) -> dict:
...
def save_models(result: dict, run_date: str) -> dict[str, Path]:
    paths: dict[str, Path] = {}
...
def write_ml_eval(result: dict, df: pd.DataFrame, run_date: str) -> None:
